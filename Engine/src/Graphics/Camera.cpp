...
void nl::gfx::Camera::setOrthographicProjection(R32 left, R32 right, R32 top, R32 bottom, R32 near, R32 far) {
...
void nl::gfx::Camera::setPerspectiveProjection(R32 fovY, R32 aspect, R32 near, R32 far) {
...
void nl::gfx::Camera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
...
void nl::gfx::Camera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
	setViewDirection(position, target - position, up);
}

void nl::gfx::Camera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) {
